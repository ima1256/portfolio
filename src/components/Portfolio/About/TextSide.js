  ...
  return (
    ...
    >
      ...
      >
        ...
        <SkillLogo skill="react" />, Node.js <SkillLogo skill="nodejs" />, and MongoDB <SkillLogo skill="mongodb" />. I focus on
        building scalable front-end interfaces and robust back-end systems <SkillLogo skill="backend" />,
        ensuring clean, maintainable code. I also leverage agile methodologies
        and modern dev tools to deliver efficient, high-quality solutions.
      </Typography>
